...
def list_script_versions():
    ...
    print(f"{BOLD}📍 Path: {NEON_YELLOW}{shorten_path(BACKUP_DIR)}{RESET}")
    ...
    print(f"{BOLD}📍 Path: {NEON_YELLOW}{shorten_path(BASE_DIR)}{RESET}")
...
def backup_all_scripts():
    ...
    print(f"{BOLD}📍 Backup Path: {NEON_YELLOW}{shorten_path(BACKUP_DIR)}{RESET}")
    ...
    print(f"\n{BOLD}🧹 {GRAY}Cleaning Up Old Versions...{RESET}")
    removed_count = 0
    for script_file in script_files:
