...
def list_script_versions():
    ...
    # <-- requested empty line before backed up scripts
    print()
    ...
    # <-- requested empty line after backed up scripts
    print()
...
def backup_all_scripts():
    ...
    # <-- requested empty line after 'Latest Version'
    print()
    ...
    # <-- requested empty line after backup section
    print()
    ...
    # <-- requested empty line before summary
    print()
